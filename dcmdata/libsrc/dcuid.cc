...
const char* dcmImageSOPClassUIDs[] = {
    ...
    UID_DermoscopicPhotographyImageStorage,
    UID_DigitalIntraOralXRayImageStorageForPresentation,
    UID_DigitalIntraOralXRayImageStorageForProcessing,//10
    UID_DigitalMammographyXRayImageStorageForPresentation,
    UID_DigitalMammographyXRayImageStorageForProcessing,
    UID_DigitalXRayImageStorageForPresentation,
    UID_DigitalXRayImageStorageForProcessing,
    ...
    UID_LegacyConvertedEnhancedCTImageStorage,
    UID_LegacyConvertedEnhancedMRImageStorage,
    UID_LegacyConvertedEnhancedPETImageStorage,//30
    UID_MRImageStorage,
    UID_MultiframeGrayscaleByteSecondaryCaptureImageStorage,
    UID_MultiframeGrayscaleWordSecondaryCaptureImageStorage,
    UID_MultiframeSingleBitSecondaryCaptureImageStorage,
    ...
    UID_OphthalmicOpticalCoherenceTomographyEnFaceImageStorage,
    UID_OphthalmicPhotography16BitImageStorage,
    UID_OphthalmicPhotography8BitImageStorage,//40
    UID_OphthalmicThicknessMapStorage,
    UID_OphthalmicTomographyImageStorage,
    UID_ParametricMapStorage,
    UID_PhotoacousticImageStorage,
    ...
    UID_SegmentationStorage,
    UID_UltrasoundImageStorage,
    UID_UltrasoundMultiframeImageStorage,//50
    UID_VideoEndoscopicImageStorage,
    UID_VideoMicroscopicImageStorage,
    UID_VideoPhotographicImageStorage,
    UID_VLEndoscopicImageStorage,
    ...
    UID_VLWholeSlideMicroscopyImageStorage,
    UID_WideFieldOphthalmicPhotographyStereographicProjectionImageStorage,
    UID_WideFieldOphthalmicPhotography3DCoordinatesImageStorage,//60
    UID_XRay3DAngiographicImageStorage,
    UID_XRay3DCraniofacialImageStorage,
    UID_XRayAngiographicImageStorage,
    UID_XRayRadiofluoroscopicImageStorage,//64
    // retired
    UID_RETIRED_HardcopyColorImageStorage,//65
    UID_RETIRED_HardcopyGrayscaleImageStorage,
    UID_RETIRED_NuclearMedicineImageStorage,
    UID_RETIRED_UltrasoundImageStorage,
    UID_RETIRED_UltrasoundMultiframeImageStorage,
...
static const DcmModalityTable modalities[] = {
    { UID_AcquisitionContextSRStorage,                             "SRa_",  4096 },
    { UID_AdvancedBlendingPresentationStateStorage,                "PSa_",  4096 },
    { UID_AmbulatoryECGWaveformStorage,                            "ECA_",  4096 },
    { UID_ArterialPulseWaveformStorage,                            "WVa_",  4096 },
    { UID_AutorefractionMeasurementsStorage,                       "OPa_",  4096 },
    { UID_BasicStructuredDisplayStorage,                           "SD__",   4096 },
    { UID_BasicTextSRStorage,                                      "SRt_",  4096 },
    { UID_BasicVoiceAudioWaveformStorage,                          "AUV_",  4096 },
    { UID_BlendingSoftcopyPresentationStateStorage,                "PSb_",  4096 },
    { UID_BodyPositionWaveformStorage,                             "WVb_",  4096 },
    { UID_BreastProjectionXRayImageStorageForPresentation,         "BX__",   4096 * 4096 * 2 },
    { UID_BreastProjectionXRayImageStorageForProcessing,           "BP__",   4096 * 4096 * 2 },
    { UID_BreastTomosynthesisImageStorage,                         "BT__",   4096 * 4096 * 2 },
    { UID_CardiacElectrophysiologyWaveformStorage,                 "WVc_",  4096 },
    { UID_CArmPhotonElectronRadiationRecordStorage,                "RRc_",  4096 },
    { UID_CArmPhotonElectronRadiationStorage,                      "Rca_",  4096 },
    { UID_ChestCADSRStorage,                                       "SRh_",  4096 },
    { UID_ColonCADSRStorage,                                       "SRo_",  4096 },
    { UID_ColorPaletteStorage,                                     "CP__",   4096 },
    { UID_ColorSoftcopyPresentationStateStorage,                   "PSc_",  4096 },
    { UID_CompositingPlanarMPRVolumetricPresentationStateStorage,  "VPc_",  4096 },
    { UID_Comprehensive3DSRStorage,                                "SR3_",  4096 },
    { UID_ComprehensiveSRStorage,                                  "SRc_",  4096 },
    { UID_ComputedRadiographyImageStorage,                         "CR__",   2048 * 2048 * 2 },
    { UID_ConfocalMicroscopyImageStorage,                          "CFm_",  1024 * 1024 },
    { UID_ConfocalMicroscopyTiledPyramidalImageStorage,            "CFt_",  1024 * 1024 * 10 },
    { UID_ContentAssessmentResultsStorage,                         "AS__",   4096 },
    { UID_CornealTopographyMapStorage,                             "CM__",   512 * 512 },
    { UID_CTDefinedProcedureProtocolStorage,                       "PPcd", 4096 },  /* was PPd */
    { UID_CTImageStorage,                                          "CT__",   512 * 512 * 2 },
    { UID_CTPerformedProcedureProtocolStorage,                     "PPcp", 4096 },  /* was PPp */
    { UID_DeformableSpatialRegistrationStorage,                    "RGd_",  4096 },
    { UID_DermoscopicPhotographyImageStorage,                      "VLd_",  768 * 576 * 3 },
    { UID_DigitalIntraOralXRayImageStorageForPresentation,         "DXo_",  1024 * 1024 * 2 },
    { UID_DigitalIntraOralXRayImageStorageForProcessing,           "DPo_",  1024 * 1024 * 2 },
    { UID_DigitalMammographyXRayImageStorageForPresentation,       "DXm_",  4096 * 4096 * 2 },
    { UID_DigitalMammographyXRayImageStorageForProcessing,         "DPm_",  4096 * 4096 * 2 },
    { UID_DigitalXRayImageStorageForPresentation,                  "DX__",   2048 * 2048 * 2 },
    { UID_DigitalXRayImageStorageForProcessing,                    "DP__",   2048 * 2048 * 2 },
    { UID_ElectromyogramWaveformStorage,                           "EMG_",  4096 },
    { UID_ElectrooculogramWaveformStorage,                         "EOG_",  4096 },
    { UID_EncapsulatedCDAStorage,                                  "CDA_",  4096 },
    { UID_EncapsulatedMTLStorage,                                  "MTL_",  4096 },
    { UID_EncapsulatedOBJStorage,                                  "OBJ_",  4096 },
    { UID_EncapsulatedPDFStorage,                                  "PDF_",  1024 * 1024 },
    { UID_EncapsulatedSTLStorage,                                  "STL_",  4096 },
    { UID_EnhancedContinuousRTImageStorage,                        "RIc_",  4096 },
    { UID_EnhancedCTImageStorage,                                  "CTe_",  256 * 512 * 512 },
    { UID_EnhancedMRColorImageStorage,                             "MRc_",  256 * 512 * 512 * 3 },
    { UID_EnhancedMRImageStorage,                                  "MRe_",  256 * 512 * 512 },
    { UID_EnhancedPETImageStorage,                                 "PIe_",  512 * 512 * 2 },
    { UID_EnhancedRTImageStorage,                                  "RIe_",  4096 },
    { UID_EnhancedSRStorage,                                       "SRe_",  4096 },
    { UID_EnhancedUSVolumeStorage,                                 "USe_",  512 * 512 },
    { UID_EnhancedXAImageStorage,                                  "XAe_",  256 * 512 * 512 },
    { UID_EnhancedXRayRadiationDoseSRStorage,                      "SRde", 4096 },
    { UID_EnhancedXRFImageStorage,                                 "RFe_",  256 * 512 * 512 },
    { UID_ExtensibleSRStorage,                                     "SRx_",  4096 },
    { UID_General32BitECGWaveformStorage,                          "ECGh", 4096 },
    { UID_GeneralAudioWaveformStorage,                             "AUG_",  4096 },
    { UID_GeneralECGWaveformStorage,                               "ECG_",  4096 },
    { UID_GenericImplantTemplateStorage,                           "IT__",   4096 },
    { UID_GrayscalePlanarMPRVolumetricPresentationStateStorage,    "VPg_",  4096 },
    { UID_GrayscaleSoftcopyPresentationStateStorage,               "PSg_",  4096 },
    { UID_HangingProtocolStorage,                                  "HP__",   4096 },
    { UID_HeightMapSegmentationStorage,                            "SGh_",  512 * 512 },
    { UID_HemodynamicWaveformStorage,                              "WVh_",  4096 },
    { UID_ImplantAssemblyTemplateStorage,                          "ITa_",  4096 },
    { UID_ImplantationPlanSRStorage,                               "SRi_",  4096 },
    { UID_ImplantTemplateGroupStorage,                             "ITg_",  4096 },
    { UID_IntraocularLensCalculationsStorage,                      "OPc_",  4096 },
    { UID_IntravascularOpticalCoherenceTomographyImageStorageForPresentation, "OCt_", 512 * 512 },
    { UID_IntravascularOpticalCoherenceTomographyImageStorageForProcessing, "OCp_", 512 * 512 },
    { UID_InventoryStorage,                                        "INV_",  4096 },
    { UID_KeratometryMeasurementsStorage,                          "OPk_",  4096 },
    { UID_KeyObjectSelectionDocumentStorage,                       "KO__",   4096 },
    { UID_LabelMapSegmentationStorage,                             "SGl_",  512 * 512 },
    { UID_LegacyConvertedEnhancedCTImageStorage,                   "CTl_",  512 * 512 * 2 },
    { UID_LegacyConvertedEnhancedMRImageStorage,                   "MRl_",  256 * 256 * 2 },
    { UID_LegacyConvertedEnhancedPETImageStorage,                  "PIl_",  512 * 512 * 2 },
    { UID_LensometryMeasurementsStorage,                           "OPl_",  4096 },
    { UID_MacularGridThicknessAndVolumeReportStorage,              "SRg_",  4096 },
    { UID_MammographyCADSRStorage,                                 "SRm_",  4096 },
    { UID_MicroscopyBulkSimpleAnnotationsStorage,                  "MAs_",  4096 },
    { UID_MRImageStorage,                                          "MR__",   256 * 256 * 2 },
    { UID_MRSpectroscopyStorage,                                   "MRs_",  256 * 512 * 512 },
    { UID_MultichannelRespiratoryWaveformStorage,                  "WVm_",  4096 },
    { UID_MultiframeGrayscaleByteSecondaryCaptureImageStorage,     "SCb_",  512 * 512 },
    { UID_MultiframeGrayscaleWordSecondaryCaptureImageStorage,     "SCw_",  512 * 512 * 2 },
    { UID_MultiframeSingleBitSecondaryCaptureImageStorage,         "SCs_",  1024 * 1024 },  /* roughly an A4 300dpi scan */
    { UID_MultiframeTrueColorSecondaryCaptureImageStorage,         "SCc_",  512 * 512 * 3 },
    { UID_MultipleVolumeRenderingVolumetricPresentationStateStorage, "VPm_" , 4096 },
    { UID_NuclearMedicineImageStorage,                             "NM__",   64 * 64 * 2 },
    { UID_OphthalmicAxialMeasurementsStorage,                      "OPx_",  4096 },
    { UID_OphthalmicOpticalCoherenceTomographyBscanVolumeAnalysisStorage, "OCb_" , 768 * 576 },
    { UID_OphthalmicOpticalCoherenceTomographyEnFaceImageStorage,  "OCe_",  768 * 576  * 2 },
    { UID_OphthalmicPhotography16BitImageStorage,                  "OPw_",  768 * 576 * 6 },
    { UID_OphthalmicPhotography8BitImageStorage,                   "OPb_",  768 * 576 * 3 },
    { UID_OphthalmicThicknessMapStorage,                           "OPm_",  768 * 576 },
    { UID_OphthalmicTomographyImageStorage,                        "OPt_",  768 * 576 * 3 },
    { UID_OphthalmicVisualFieldStaticPerimetryMeasurementsStorage, "OPp_",  4096 },
    { UID_ParametricMapStorage,                                    "PM__",   256 * 256 * 4 },
    { UID_PatientRadiationDoseSRStorage,                           "SRq_",  4096 },
    { UID_PerformedImagingAgentAdministrationSRStorage,            "SRi_",  4096 },
    { UID_PhotoacousticImageStorage,                               "PA__",   256 * 512 * 512 },
    { UID_PlannedImagingAgentAdministrationSRStorage,              "SRj_",  4096 },
    { UID_PositronEmissionTomographyImageStorage,                  "PI__",   512 * 512 * 2 },
    { UID_ProcedureLogStorage,                                     "SRp_",  4096 },
    { UID_ProtocolApprovalStorage,                                 "PAp_",  4096 },  /* was PA */
    { UID_PseudoColorSoftcopyPresentationStateStorage,             "PSp_",  4096 },
    { UID_RadiopharmaceuticalRadiationDoseSRStorage,               "SRr_",  4096 },
    { UID_RawDataStorage,                                          "RAW_",  256 * 512 * 512 },
    { UID_RealWorldValueMappingStorage,                            "RWM_",  4096 },
    { UID_RespiratoryWaveformStorage,                              "WVr_",  4096 },
    { UID_RoboticArmRadiationStorage,                              "Rra_",  4096 },  /* was RRr */
    { UID_RoboticRadiationRecordStorage,                           "RRr_",  4096 },
    { UID_RoutineScalpElectroencephalogramWaveformStorage,         "EEG_",  4096 },
    { UID_RTBeamsDeliveryInstructionStorage,                       "RTd_",  4096 },
    { UID_RTBeamsTreatmentRecordStorage,                           "RTb_",  4096 },
    { UID_RTBrachyApplicationSetupDeliveryInstructionStorage,      "RTa_",  4096 },
    { UID_RTBrachyTreatmentRecordStorage,                          "RTr_",  4096 },
    { UID_RTDoseStorage,                                           "RD__",   4096 },
    { UID_RTImageStorage,                                          "RI__",   4096 },
    { UID_RTIonBeamsTreatmentRecordStorage,                        "RTi_",  4096 },
    { UID_RTIonPlanStorage,                                        "RPi_",  4096 },
    { UID_RTPatientPositionAcquisitionInstructionStorage,          "RPp_",  4096 },
    { UID_RTPlanStorage,                                           "RP__" ,  4096 },
    { UID_RTPhysicianIntentStorage,                                "RIp_",  4096 },
    { UID_RTRadiationRecordSetStorage,                             "RSr_",  4096 },
    { UID_RTRadiationSalvageRecordStorage,                         "RRs_",  4096 },
    { UID_RTRadiationSetDeliveryInstructionStorage,                "RSd_",  4096 },
    { UID_RTRadiationSetStorage,                                   "RSe_",  4096 },  /* was RRs */
    { UID_RTSegmentAnnotationStorage,                              "RAs_",  4096 },  /* was RRs */
    { UID_RTStructureSetStorage,                                   "RS__",   4096 },
    { UID_RTTreatmentPreparationStorage,                           "RTp_",  4096 },
    { UID_RTTreatmentSummaryRecordStorage,                         "RTs_",  4096 },
    { UID_SecondaryCaptureImageStorage,                            "SC__",   512 * 512 * 2 },
    { UID_SegmentationStorage,                                     "SG__",   512 * 512 },
    { UID_SegmentedVolumeRenderingVolumetricPresentationStateStorage, "VPs_", 4096 },
    { UID_SimplifiedAdultEchoSRStorage,                            "SRu_",  4096 },
    { UID_SleepElectroencephalogramWaveformStorage,                "WVs_",  4096 },
    { UID_SpatialFiducialsStorage,                                 "FID_",  4096 },
    { UID_SpatialRegistrationStorage,                              "RGs_",  4096 },
    { UID_SpectaclePrescriptionReportStorage,                      "SRs_",  4096 },
    { UID_StereometricRelationshipStorage,                         "OPr_",  4096 },
    { UID_SubjectiveRefractionMeasurementsStorage,                 "OPs_",  4096 },
    { UID_SurfaceScanMeshStorage,                                  "SSm_",  4096 },
    { UID_SurfaceScanPointCloudStorage,                            "SSp_",  4096 },
    { UID_SurfaceSegmentationStorage,                              "SGs_",  4096 },
    { UID_TomotherapeuticRadiationRecordStorage,                   "RRt_",  4096 },
    { UID_TomotherapeuticRadiationStorage,                         "Rto_",  4096 },  /* was RRt */
    { UID_TractographyResultsStorage,                              "TR__",   4096 },
    { UID_TwelveLeadECGWaveformStorage,                            "TLE_",  4096 },
    { UID_UltrasoundImageStorage,                                  "US__",   512 * 512 },
    { UID_UltrasoundMultiframeImageStorage,                        "USm_",  512 * 512 },
    { UID_VariableModalityLUTSoftcopyPresentationStateStorage,     "PSv_",  4096 },
    { UID_VideoEndoscopicImageStorage,                             "VVe_",  768 * 576 * 3 },
    { UID_VideoMicroscopicImageStorage,                            "VVm_",  768 * 576 * 3 },
    { UID_VideoPhotographicImageStorage,                           "VVp_",  768 * 576 * 3 },
    { UID_VisualAcuityMeasurementsStorage,                         "OPv_",  4096 },
    { UID_VLEndoscopicImageStorage,                                "VLe_",  768 * 576 * 3 },
    { UID_VLMicroscopicImageStorage,                               "VLm_",  768 * 576 * 3 },
    { UID_VLPhotographicImageStorage,                              "VLp_",  768 * 576 * 3 },
    { UID_VLSlideCoordinatesMicroscopicImageStorage,               "VLs_",  768 * 576 * 3 },
    { UID_VLWholeSlideMicroscopyImageStorage,                      "VLw_",  10000 * 10000 * 3 },
    { UID_VolumeRenderingVolumetricPresentationStateStorage,       "VPv_",  4096 },
    { UID_WaveformAcquisitionPresentationStateStorage,             "PSq_",  4096 },
    { UID_WaveformAnnotationSRStorage,                             "SRw_",  4096 },
    { UID_WaveformPresentationStateStorage,                        "PSw_",  4096 },
    { UID_WideFieldOphthalmicPhotographyStereographicProjectionImageStorage, "OWs_", 768 * 576 * 3 },
    { UID_WideFieldOphthalmicPhotography3DCoordinatesImageStorage, "OW3_",  768 * 576 * 3 },
    { UID_XADefinedProcedureProtocolStorage,                       "PPxd", 4096 },
    { UID_XAPerformedProcedureProtocolStorage,                     "PPxp", 4096 },
    { UID_XAXRFGrayscaleSoftcopyPresentationStateStorage,          "PSx_",  4096 },
    { UID_XRay3DAngiographicImageStorage,                          "XA3_",  256 * 512 * 512 },
    { UID_XRay3DCraniofacialImageStorage,                          "XC3_",  256 * 512 * 512 },
    { UID_XRayAngiographicImageStorage,                            "XA__",   256 * 512 * 512 },
    { UID_XRayRadiationDoseSRStorage,                              "SRd_",  4096 },
    { UID_XRayRadiofluoroscopicImageStorage,                       "RF__",   256 * 512 * 512 },
    // retired
    { UID_RETIRED_HardcopyColorImageStorage,                       "HC__",   4096 },
    { UID_RETIRED_HardcopyGrayscaleImageStorage,                   "HG__",   4096 },
    { UID_RETIRED_NuclearMedicineImageStorage,                     "NMr_",  64 * 64 * 2 },
    { UID_RETIRED_StandaloneCurveStorage,                          "CV__",   4096 },
    { UID_RETIRED_StandaloneModalityLUTStorage,                    "ML__",   4096 * 2 },
    { UID_RETIRED_StandaloneOverlayStorage,                        "OV__",   512 * 512 },
    { UID_RETIRED_StandalonePETCurveStorage,                       "PC__",   4096 },
    { UID_RETIRED_StandaloneVOILUTStorage,                         "VO__",   4096 * 2 },
    { UID_RETIRED_StoredPrintStorage,                              "SP__",   4096 },
    { UID_RETIRED_UltrasoundImageStorage,                          "USr_",  512 * 512 },
    { UID_RETIRED_UltrasoundMultiframeImageStorage,                "USf_",  512 * 512 },
    { UID_RETIRED_VLImageStorage,                                  "VLr_",  768 * 576 * 3 },
    { UID_RETIRED_VLMultiframeImageStorage,                        "VMr_",  768 * 576 * 3 },
    { UID_RETIRED_XRayAngiographicBiPlaneImageStorage,             "XB__",   512 * 512 * 2 },
    // draft
    ...
    // DICOS
    { UID_DICOS_CTImageStorage,                                    "CTs_",  512 * 512 * 2 },
    { UID_DICOS_DigitalXRayImageStorageForPresentation,            "DXs_",  2048 * 2048 * 2 },
    { UID_DICOS_DigitalXRayImageStorageForProcessing,              "DPs_",  2048 * 2048 * 2 },
    { UID_DICOS_ThreatDetectionReportStorage,                      "TDR_",  4096 },
    { UID_DICOS_2DAITStorage,                                      "AI2_",  4096 },
    { UID_DICOS_3DAITStorage,                                      "AI3_",  4096 },
    { UID_DICOS_QuadrupoleResonanceStorage,                        "QR__",   4096 },
    // DICONDE
    { UID_DICONDE_EddyCurrentImageStorage,                         "EC__",   512 * 512 },
    { UID_DICONDE_EddyCurrentMultiframeImageStorage,               "ECm_",  512 * 512 },
    { UID_DICONDE_ThermographyImageStorage,                        "TG__",   512 * 512 },
    { UID_DICONDE_ThermographyMultiFrameImageStorage,              "TGm_",  512 * 512 },
    { UID_DICONDE_UltrasoundWaveformStorage,                       "UW__",   4096 }
};
